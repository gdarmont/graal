 ...
 *
 * <p>
 * The asynchronous nature of the signal means that the OS could invoke the signal handler at any
 * time (could be during GC, VM operation, uninterruptible code) and that the signal handler can
 * only execute specific code i.e. the calls that are asynchronous signal safe.
 * </p>
 *
 * <p>
 ...
 * <li>Do a stack walk and write IPs into buffer.</li>
 * </ol>
 * </p>
 * 
 * <p>
 ...
 *
 * <p>
 * The {@link SamplerBuffer} that we are using in this consumer-producer communication is allocated
 ...
 * <ul>
 * <li>Producer (signal handler):
 * <ol>
 * <li>pops the buffer from the pool of available buffers (the buffer now becomes
 * thread-local),</li>
 * <li>writes the IPs into buffer,</li>
 * <li>if the buffer is full, moves it to a pool with buffers that awaits processing.</li>
 * </ol>
 * </li>
 * <li>Consumer (recorder thread):
 * <ol>
 * <li>pops the buffer from the pool of full buffers,</li>
 * <li>reconstructs the stack walk based on IPs,</li>
 * <li>pushes the buffer into pool of available buffers.</li>
 * </ol>
 * </li>
 * </ul>
